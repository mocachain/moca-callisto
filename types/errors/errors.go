...
var (
	...
	ErrInvalidGRN            = errors.Register(RootCodespace, 1008, "Not a standard moca resource name format")
	...
	ErrGRNTypeMismatch = errors.Register(RootCodespace, 2000, "Moca resource type mismatch")
)
