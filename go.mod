...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/mocachain/moca-cosmos-sdk v1.2.0-rc20-b329d8b
	...
	github.com/forbole/juno/v5 => github.com/mocachain/moca-callisto-juno/v5 v5.0.1-rc1-4d1ecd1
