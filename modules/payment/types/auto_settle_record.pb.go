...
// source: moca/payment/auto_settle_record.proto
...
func init() {
	proto.RegisterType((*AutoSettleRecord)(nil), "moca.payment.AutoSettleRecord")
}

func init() {
	proto.RegisterFile("moca/payment/auto_settle_record.proto", fileDescriptor_e3fb6b8de54e2985)
}
