...
func (Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_8cda14ef8a38ca2a, []int{0}
}
...
func (*StorageProvider) Descriptor() ([]byte, []int) {
	return fileDescriptor_8cda14ef8a38ca2a, []int{1}
}
...
func (*RewardInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_8cda14ef8a38ca2a, []int{2}
}
...
func (*SpStoragePrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_8cda14ef8a38ca2a, []int{3}
}
...
func (*GlobalSpStorePrice) Descriptor() ([]byte, []int) {
	return fileDescriptor_8cda14ef8a38ca2a, []int{4}
}
...
func (*SpMaintenanceStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_8cda14ef8a38ca2a, []int{5}
}
...
func (*MaintenanceRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_8cda14ef8a38ca2a, []int{6}
}
...
func init() { proto.RegisterFile("moca/sp/types.proto", fileDescriptor_8cda14ef8a38ca2a) }

var fileDescriptor_8cda14ef8a38ca2a = []byte{
	...
	,
}
